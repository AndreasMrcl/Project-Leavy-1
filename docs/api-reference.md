...
| 409 | Conflict (mis. open-bill chair sudah ada, shift belum ditutup) | Display pesan ke user — bukan bug, butuh aksi user |
...
> ⚠️ `no_order` lama akan di-replace dengan yang baru. Mobile harus update referensi.
