                ...
                <div class="p-5 overflow-auto">
                    ...
                    @if ($settlements->isEmpty())
                        ...
                        <div class="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-600 mb-2">No settlements yet</h3>
                            <p class="text-gray-500 mb-6">Open your first shift to start tracking the cash drawer</p>
                            <button id="emptyStartBtn" aria-label="Open first shift"
