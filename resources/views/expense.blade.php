...
<body class="bg-gray-50 font-sans">
                ...
                <div class="p-5 overflow-auto">
                    ...
                    @if ($expenses->isEmpty())
                        ...
                        <div class="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-600 mb-2">No expenses yet</h3>
                            <p class="text-gray-500 mb-6">Get started by recording your first expense</p>
                            <button id="emptyAddBtn" aria-label="Add first expense"
    ...
    @include('modal.addExpense')
    @include('modal.editExpense')

    <!-- SCRIPTS -->
    <script src="https://code.jquery.com/jquery-3.7.1.min.js"
        integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
    <script src="//cdn.datatables.net/2.0.2/js/dataTables.min.js"></script>
    <script src="{{ asset('modal/expense.js') }}"></script>
